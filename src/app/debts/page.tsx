...
export default function DebtsPage() {
  return (
    <>
      <PageHeader title="Debts" description="Manage your loans and installment plans.">
        <Button>
          ...
          return (
            <Card key={debt.id}>
              <CardHeader>
                ...
                <CardDescription>Creditor: {debt.creditor}</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardFooter>
                <Accordion type="single" collapsible className="w-full">
                  <AccordionItem value="installments">
                    <AccordionTrigger>View Installments</AccordionTrigger>
                    <AccordionContent>
                      <Table>
                        <TableHeader>
                          <TableRow>
