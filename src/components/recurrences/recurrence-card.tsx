        ...
        <CardContent className="p-4 flex items-center justify-between">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            <div className="flex gap-1">
              ...
              <Button variant="ghost" size="icon" className="h-7 w-7 text-amber-600 hover:bg-amber-100 hover:text-amber-700" onClick={() => setIsConfirmingStop(true)}>
                <X className="h-4 w-4" />
              </Button>
              <Button variant="ghost" size="icon" className="h-7 w-7 text-destructive hover:bg-destructive/10" onClick={() => setIsDeleteDialogOpen(true)}>
