      ...
      modules: [
        {
          ...
          points: [
            {
              title: '**Dinheiro é 80% comportamento.**',
              details: `Falar de finanças quase nunca é falar de números. É falar de **emoções, impulsos e hábitos**.\n\nA maior parte das decisões que tomamos com dinheiro nasce muito antes de pegar a calculadora: nasce quando sentimos ansiedade, tédio, ou vontade de compensar um dia ruim.\n\nPerceber isso muda tudo. Quando você entende que sua relação com o dinheiro não depende de ser um gênio da matemática, mas de reconhecer seus próprios gatilhos, o peso e a culpa diminuem. E a mudança começa.`
            },
            {
              title: '**O "próximo passo" é mais importante que a perfeição.**',
              details: 'A vida financeira de outras pessoas não é a sua. Cada um tem uma história e desafios únicos. Comparar-se com os outros só serve para paralisar.\n\nO objetivo aqui não é julgar seu passado, mas sim iluminar o caminho para a *sua próxima pequena decisão*. O que importa é o movimento, não a velocidade.'
            },
            {
