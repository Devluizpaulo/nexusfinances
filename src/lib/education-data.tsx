        ...
        points: [
          {
            ...
            details: 'Dinheiro é 80% comportamento. Falar de finanças quase nunca é falar de números. É falar de emoções, impulsos, crenças que vieram da infância e hábitos que repetimos no piloto automático. A maior parte das decisões que tomamos sobre dinheiro nasce muito antes de pegar uma calculadora: nasce quando sentimos ansiedade, tédio, medo de perder algo ou vontade de compensar um dia ruim.\n\nPerceber isso muda tudo. Quando você entende que sua relação com o dinheiro não depende de ser um gênio da matemática, mas de reconhecer seus próprios gatilhos, o peso diminui. A culpa diminui. A mudança começa.\n\nPor que você gasta para aliviar estresse? Por que deixa de olhar seu extrato por medo do que vai encontrar? Por que endivida o futuro para agradar alguém no presente? Essas perguntas não são sobre finanças — são sobre você.\n\nEducar-se financeiramente é, antes de qualquer técnica, um processo de autoconhecimento. É aprender a perceber seus padrões. É identificar o momento exato em que o impulso aparece. É saber diferenciar necessidade de carência emocional. É transformar “preciso comprar agora” em “posso decidir com calma”.\n\nQuando você domina seus comportamentos, os números finalmente começam a fazer sentido. E, quando isso acontece, a saúde financeira deixa de ser um esforço e vira consequência. Você recupera o controle. Você ganha liberdade. E dinheiro volta a ser ferramenta — não inimigo.'
          },
          {
