...
const prompt = ai.definePrompt({
    ...
    prompt: `
        ...
        4.  **issueDate (Data de Emissão/Competência)**: A data a que o pagamento se refere. Formate-a como YYYY-MM-DD.
        5.  **description (Descrição)**: Crie uma descrição curta e informativa. Ex: "Salário referente a Abril/2024" ou "Pagamento de serviço para Empresa X".
